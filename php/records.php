...
<table border=1 style = 'border-collapse: collapse'>
  <tr>
    ...
    foreach ($recordsList as $value) {
      ...
      echo "<td><form action='records.php' method='get'><input type='hidden' name='id' value='".$value->getId()."'><input type='submit' name='mode' value='Details'></form>";
